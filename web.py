...
def main():
    ...
    youtube_link = st.text_input("🔎 Enter the YouTube link 🔗 of the song to convert: Example (https://www.youtube.com/watch?v=JxBnLmCOEJ8)", "https://www.youtube.com/watch?v=JxBnLmCOEJ8")
