...
def main():
    ...
    with st.form(key='youtube_link_form'):
            youtube_link = st.text_input("🔎 Enter the YouTube link 🔗 of the song to convert:", value="https://www.youtube.com/watch?v=JxBnLmCOEJ8", help="Example this URL Ai muốn nghe không - Đen Vâu")
